...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "jd6jd".to_string());
        RwLock::new(map)
    };    
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["172.31.32.181"];
pub const RS_PUB_KEY: &str = "CTN3F4gQ6PYf6eCoOJPUnDdKcrhYSvYTaWzp6glk1ps=";
